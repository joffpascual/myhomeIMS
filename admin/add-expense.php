...
<head>
		...
		<!-- Title -->
		<title><?php echo $lang['AddExpenses'];?></title>
			...
			<div class="site-content">
				...
				<div class="content-area py-1">
					<div class="container-fluid">
						<h4><?php echo $lang['AddExpenses'];?></h4>
						<ol class="breadcrumb no-bg mb-1">
							<li class="breadcrumb-item"><a href="index.php"><?php echo $lang['Dashboard'];?></a></li>							
							<li class="breadcrumb-item active"><?php echo $lang['AddExpenses'];?></li>
						</ol>                       
			   ...
			   function submitForm()
				{
					...
					NProgress.start();
					var data = $("#addexpinvoice").serialize();
			
					$.ajax({
			
						type : 'POST',
						url  : 'modal/add_expinvoiceModel.php',
						data : data,
						dataType : 'json',
