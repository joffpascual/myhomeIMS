				...
				<div class="content-area py-1">
					<div class="container-fluid">
						...
						<div class="box box-block bg-white">
							<h5 class="mb-1"><?php echo $lang['ExportingInvoicesData'];?></h5>
							...
							<table class="table table-striped table-bordered" id="table-2">
								...
								<tbody>
                                <?php 
								$sql = "SELECT c.*, inv.* FROM invoice_payment_detail as inv, customers as c where c.cus_id=inv.customer_id";
								...
								if ($result->num_rows > 0) 
								{
									...
									<tr>
                                       ...
                                       <?php  if(!empty($_SESSION['user_type_id']) && $_SESSION['user_type_id']!='2') { ?>
                                        ...
                                        <a class="btn btn-danger btn-sm" href="invoices.php?i=<?php echo $row['invoice_no_id'];?>&o=<?php echo $row['order_id'];?>" title="Delete"><i class="ti-trash mr-0-5"></i><?php echo $lang['Delete'];?></a>
                                        <?php } ?>
                                        </td>
									</tr>
                                  <?php $i++;
