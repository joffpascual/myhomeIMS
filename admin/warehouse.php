...
if(isset($_GET['w']) && !empty($_GET['w'])){
	$w=strip_tags(trim($_GET['w']));
	$del = "DELETE FROM warehouse WHERE war_id='$w'";
	if ($conn->query($del) === TRUE) {
		header("location: warehouse.php?d=del");		
	} else {
		header("location: warehouse.php?d=n");		
	}
}
?>
<!DOCTYPE html>
...
<head>
		...
		<!-- Title -->
		<title><?php echo $lang['Warehouse'];?></title>
			...
			<div class="site-content">
				...
				<div class="content-area py-1">
					<div class="container-fluid">
						<h4><?php echo $lang['WarehouseList'];?></h4>
						<ol class="breadcrumb no-bg mb-1">
							<li class="breadcrumb-item"><a href="index.php"><?php echo $lang['Dashboard'];?></a></li>							
							<li class="breadcrumb-item active"><?php echo $lang['WarehouseList'];?></li>
						</ol>
                        
						<div class="box box-block bg-white">                        	                      	
                        <h5 class="mb-1"><?php echo $lang['ExportingWarehouse'];?></h5>
                        <table class="table table-striped table-bordered dataTable" id="table-2">
                            ...
                            {	
                                ...
                                <tr>
                                    ...
                                    <a class="btn btn-secondary btn-sm" href="edit-warehouse.php?w=<?php echo $row['war_id'];?>" title="Edit"><i class="ti-pencil mr-0-5"></i><?php echo $lang['Edit'];?></a> 
                                    <a class="btn btn-danger btn-sm" href="warehouse.php?w=<?php echo $row['war_id'];?>" title="Delete"><i class="ti-trash mr-0-5"></i><?php echo $lang['Delete'];?></a>
                                    <?php } ?>
                                    </td>
                                </tr>
                              <?php $i++; }
