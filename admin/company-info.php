							...
							<form class="form-material material-primary" id="editsetting">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <option <?php if(isset($setting_currency) && ($setting_currency=='PHP')) echo "selected";?> value="PHP">PHP</option>
                                        <option <?php if(isset($setting_currency) && ($setting_currency=='P')) echo "selected";?> value="P">P</option>								
										</select>
									</div>
								</div>  
                                <div class="form-group row">
