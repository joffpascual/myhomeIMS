			...
			<div class="site-content">
				...
				<div class="content-area py-1">
					<div class="container-fluid">
						<h4><?php echo $lang['Edit'];?> <?php echo $lang['Categories'];?></h4>
						<ol class="breadcrumb no-bg mb-1">
							<li class="breadcrumb-item"><a href="index.php"><?php echo $lang['Dashboard'];?></a></li>	
                            <li class="breadcrumb-item"><a href="categories.php"><?php echo $lang['CategoriesList'];?></a></li>						
							<li class="breadcrumb-item active"><?php echo $lang['Edit'];?> <?php echo $lang['Categories'];?></li>
						</ol>
						<div class="box box-block bg-white">
							<h5><?php echo $lang['Edit'];?> <?php echo $lang['Categories'];?></h5>
							<p class="font-90 text-muted mb-1"> <?php echo $lang['usethisformtoeditcategoryname'];?>.</p>
							<form class="form-material material-primary" id="editcategory">								
                                <div class="form-group row">
									<label for="Category" class="col-sm-2 col-form-label"><?php echo $lang['Categories'];?></label>
									<div class="col-sm-10">
			   ...
			   function submitForm()
				{
					...
					$.ajax({
						...
						type : 'POST',
						url  : 'modal/edit_categoryModel.php',
						data : data,
						dataType : 'json',
						...
						//alert(data.status);
							...
							else if(data.status==='successfully')
							{
									...
									setTimeout('$(".bg-white").fadeOut(700, function(){ window.location = "categories.php" }); ',800);
