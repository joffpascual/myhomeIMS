...
<head>
		...
		<!-- Title -->
		<title><?php echo $lang['PaidCustomers'];?> <?php echo $lang['Invoice'];?></title>
			...
			<div class="site-content">
				...
				<div class="content-area py-1">
					<div class="container-fluid">
						<h4><?php echo $lang['PaidCustomersInvoicesList'];?></h4>
						<ol class="breadcrumb no-bg mb-1">
							<li class="breadcrumb-item"><a href="index.php"><?php echo $lang['Dashboard'];?></a></li>							
							<li class="breadcrumb-item active"><?php echo $lang['PaidCustomersInvoicesList'];?></li>
						</ol>
						<div class="box box-block bg-white">
							<h5 class="mb-1"><?php echo $lang['ExportingPaidCustomersInvoicesData'];?></h5>
							<table class="table table-striped table-bordered dataTable" id="table-2">
								...
								<tbody>
                                <?php 
								$sql = "SELECT c.*, inv.* FROM invoice_payment_detail as inv, customers as c where c.cus_id=inv.customer_id and inv.due_amount='0'";
