...
if(isset($_GET['c']) && !empty($_GET['c'])){
	...
	$del = "DELETE FROM categories WHERE cat_id='$c'";
	if ($conn->query($del) === TRUE) {
		header("location: categories.php?d=del");		
	} else {
		header("location: categories.php?d=n");		
	}
}
?>
<!DOCTYPE html>
			...
			<div class="site-content">
				...
				<div class="content-area py-1">
					<div class="container-fluid">
						<h4><?php echo $lang['CategoriesList'];?></h4>
						<ol class="breadcrumb no-bg mb-1">
							<li class="breadcrumb-item"><a href="index.php"><?php echo $lang['Dashboard'];?></a></li>							
							<li class="breadcrumb-item active"><?php echo $lang['CategoriesList'];?></li>
						</ol>
						<div class="box box-block bg-white">
							<h5 class="mb-1"><?php echo $lang['ExportingCategories'];?></h5>
							<table class="table table-striped table-bordered dataTable" id="table-2">
								...
								{	
									...
									<tr>
                                        ...
                                        <a class="btn btn-secondary btn-sm" href="edit-categories.php?c=<?php echo $row['cat_id'];?>" title="Edit"><i class="ti-pencil mr-0-5"></i><?php echo $lang['Edit'];?></a> 
                                        <a class="btn btn-danger btn-sm" href="categories.php?c=<?php echo $row['cat_id'];?>" title="Delete"><i class="ti-trash mr-0-5"></i><?php echo $lang['Delete'];?></a>
                                        <?php } ?>
                                        </td>
									</tr>
                                  <?php $i++; }
